...
def run_interactive_test(host="http://localhost:8000"):
    ...
    print("Open your browser to http://localhost:8089 to access the Locust web interface")
...
def main():
    parser = argparse.ArgumentParser(description="Run load tests for Localization Manager Backend")
    parser.add_argument("--users", type=int, default=10, help="Number of users (default: 10)")
    parser.add_argument("--spawn-rate", type=int, default=2, help="Users spawned per second (default: 2)")
    parser.add_argument("--run-time", type=int, default=60, help="Test duration in seconds (default: 60)")
    parser.add_argument("--host", default="http://localhost:8000", help="Target host (default: http://localhost:8000)")
    parser.add_argument("--interactive", action="store_true", help="Run interactive test with web UI")
